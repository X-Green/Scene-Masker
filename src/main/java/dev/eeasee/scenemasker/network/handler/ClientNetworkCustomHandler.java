...
import dev.eeasee.scenemasker.network.packet.s2c.SettingsS2C;
...
public class ClientNetworkCustomHandler {
    public static void registerPacketData() {
        ...
        ClientSidePacketRegistry.INSTANCE.register(MaskerIdentifiers.SETTINGS_S2C, ((context, buffer) -> IDataS2C.consume(context, buffer, new SettingsS2C())));
    }
}
